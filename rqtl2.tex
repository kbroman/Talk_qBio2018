...
\subtitle{developing, maintaining, and supporting \\ scientific software}
...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/qBio2018}{\tt \scriptsize
  \color{foreground} bit.ly/qBio2018}
}
...
\frame{
  ...
  \note{These are slides for a talk that I will give in the qBio
    series at UW-Madison on 14 Feb 2018.

    Source: {\tt https://github.com/kbroman/Talk\_qBio2018} \\
    Slides: {\tt http://bit.ly/qBio2018}
}
} }
